...
1. **Nous** allons créer un fichier pour y **écrire le code de ce script** : 
	- [Création-script](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Création-script.md)
	- [Shebang](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Shebang.md).
2. **Il** faudra **vérifier** qu'au moins un **argument** a été reçu :
	- [Structures-Conditionnelles](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Structures-Conditionnelles.md) et [Conditions-composite](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Conditions-composite.md)
	- [[Variables-Speciales#Arguments et Paramètres]] avec `$1`
	- [Conditions](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Conditions.md) (sur chaîne de caractère) avec `-z`
3. **Sortir** du script en signalant une erreur si l'argument n'est pas valide :
	- [exit](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/exit.md)
4. **Vérifier** qu'il s'agit bien d'un dossier :
	- [Structures-Conditionnelles](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Structures-Conditionnelles.md) et [Conditions-composite](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Conditions-composite.md)
	- [Conditions](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Conditions.md) (sur fichier) avec `-d`
...
6. **Déclarer** quelques [**variables**](https://www.formatux.fr/formatux-bash/module-010-niveau1/index.html#variables) :
	- Une variable `workingdir` pour stocker le répertoire d'où le script est exécuté :
		...
		2. Avec le nom du script, récupérer le chemin absolu :
			- [realpath](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/commandes-de-base/gestion_fichiers/realpath.md) 
		3. Ensuite a partir du chemin absolu on peut récupérer le dossier :
			- nous utiliserons la [Substitution-de-commandes](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Substitution-de-commandes.md) pour [realpath](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/commandes-de-base/gestion_fichiers/realpath.md)
			- nous passerons ce résulta à [dirname](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/commandes-de-base/gestion_fichiers/dirname.md)
	...
	- Une variable `array` pour stocker la liste des dépôts GitHub.
		- Stocker la sortie de la commande [[02_RESSOURCES/Linux/programme/find]] dans la variable `array` de type  **Tableaux**. `array=($(find))`
			- [Tableaux](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Tableaux.md)
			- [Expansion-de-Tableau](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Expansion-de-Tableau.md)
			- [Substitution-de-commandes](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Substitution-de-commandes.md)
7. **Nous** allons donc utiliser la **commande**  [[02_RESSOURCES/Linux/programme/find]] 
	...
	- [Substitution-de-commandes](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Substitution-de-commandes.md) : Permet de capturer la sortie d'une commande pour l'utiliser comme une variable ou une autre commande.
	...
	- La **sortie standard (1)** sera **redirigée** via la [Substitution-de-commandes](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Substitution-de-commandes.md)
...
8. **Maintenant** que nous avons notre **liste de dossier**, on peut utiliser la **boucle** `for` pour **itérer** sur chaque **élément** de la liste.
	- Nous aurons besoins d'utiliser des fonctionnalités spécifique aux variables de type Array : 
		...
		- [Expansion-de-Paramètre](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Expansion-de-Paramètre.md)
...
- [Conditions-composite](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Conditions-composite.md)
- [Extension-arithmétique](../../../../../../../../_I0_DOCU_EXT/mk-docs/documentations_linux/docs/langages/bash/bash-docu/Extension-arithmétique.md)
